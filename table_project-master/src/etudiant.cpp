...
unsigned int Etudiant::getNum() const { return num; }

bool Etudiant::getOcc() const { return occ; }

unsigned int Etudiant::getNbEssai() const { return nbEssais; }

unsigned int Etudiant::getAge() const { return age; }

Etudiant* Etudiant::getSuiv() const { return suiv; }


void Etudiant::setNum(unsigned int i) { num = i; }

void Etudiant::setOcc(bool b) {	occ = b; }

void Etudiant::setNbEssais(unsigned int i) { nbEssais = i; }

void Etudiant::setAge(unsigned int i) { age = i; }
